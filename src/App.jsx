      ...
      <div className="w-full max-w-sm bg-slate-950 rounded-[2.5rem] p-3 shadow-2xl">
        <div className="bg-slate-50 rounded-[2rem] overflow-hidden min-h-[850px] relative">
          ...
          <div className="p-4 space-y-4" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
            ...
            <div className="sticky bottom-0 z-40 bg-slate-50/95 backdrop-blur border-t border-slate-200 pt-3 pb-2 flex gap-2">
              <Button onClick={goPrev} variant="outline" className="rounded-2xl flex-1 py-3 text-base">
                Previous
              </Button>
              <Button onClick={goNext} className="rounded-2xl bg-emerald-700 hover:bg-emerald-800 flex-1 py-3 text-base">
                Next plant
              </Button>
            </div>
